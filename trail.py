...
if not st.session_state['logged_in']:
    ...
    def generate_resources(path, learning_style="General"):
        prompt = f"""
        Suggest learning resources for {path} suitable for {learning_style} learners.
        Include real, accessible links to resources. Format the response like below and populate the avaiable and accessible resources only:

        ONLINE COURSES:
        - [Coursera - Course Title](https://www.coursera.org/...): Brief description
        - [edX - Course Title](https://www.edx.org/...): Brief description
        - [Udemy - Course Title](https://www.udemy.com/...): Brief description

        BOOKS AND MATERIALS:
        - [Book Title](https://www.amazon.com/...): Author, Brief description
        - [PDF Resource](https://...): Brief description
        - [Online Tutorial](https://...): Brief description

        PRACTICE PLATFORMS:
        - [Platform Name](https://...): Brief description of exercises
        - [Interactive Tool](https://...): Brief description
        - [Practice Site](https://...): Brief description

        COMMUNITY RESOURCES:
        - [Discord Community](https://discord.gg/...): Active learning community
        - [Reddit Subreddit](https://reddit.com/r/...): Discussion forum
        - [Stack Exchange](https://...): Q&A platform

        VIDEO TUTORIALS:
        - [Video Title](https://www.youtube.com/...): Creator name, Brief description
        - [Tutorial Series](https://www.youtube.com/...): Channel name, Topics covered
        - [Workshop Recording](https://www.youtube.com/...): Institution, Content overview

        Ensure all links are to real, popular, and highly-rated resources.
        """
        try:
            response = model.generate_content(prompt)
            ...
            return "Unable to generate resources at this time. Please try again later."
